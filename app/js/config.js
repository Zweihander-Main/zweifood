...
Object.defineProperties(appConfigObject, {
	...
	yelp_searchAPIProperties: {
		get: function() {
			...
			returnObject.basic_URL = self.searchAPIInfo.yelp.baseURL + 'search/';
			returnObject.detailed_URL = self.searchAPIInfo.yelp.baseURL + 'business/';
	...
	locu_searchAPIProperties: {
		get: function() {
			...
			returnObject.settings = settings;
			returnObject.basicExtraParameters = basicExtraParameters;
			returnObject.basic_URL = self.searchAPIInfo.locu.baseURL + 'search/';
